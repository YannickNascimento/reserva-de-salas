...
<?php
	...
	echo $this->Form->Input('userType', array('legend' => __('Tipo de usuário'), 'options' => array('Employee' => __('Empregado'), 'Student' => __('Estudante'), 'Professor' => __('Professor')), 'type' => 'radio', 'class' => 'userTypeRadio'));
?>
